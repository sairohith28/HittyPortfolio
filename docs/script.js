...
// Enhanced Theme Toggle with Sound Effect (Optional)
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        const mailtoLink = `mailto:vulapusairohith28@gmail.com?subject=${subject}&body=${body}`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const animateElements = document.querySelectorAll('.project-card, .experience-item, .certification-item');
...
if (footerText) {
    footerText.textContent = `© ${currentYear} Sai Rohith Vulapu. All rights reserved.`;
}